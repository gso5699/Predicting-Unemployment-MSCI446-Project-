...
def run_rnn(
    ...
    for epoch in range(num_epochs):
        ...
        # TODO: Implement a validation loop
        ###################################
        val_loss = loss.item() # currently a placeholder
    ...
    model.eval() #currently not loading the best model
    ...
    plt.scatter(data_unscaled.index[train_size+seq_length:], y_test, label='Actual',alpha=0.4)
    plt.scatter(data_unscaled.index[train_size+seq_length:], y_pred, label='Predicted',alpha=0.4)
    plt.xlabel('Date')
